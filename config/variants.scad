...
variants = [
    ...
    // inner diameter, shell wall, top/bottom skin, segments,
    // usable bed width, profile, fill port diameter, vent diameter

    ["POC_06IN_13T",  36, 18, 13,  28, 1.0,  80, 2.4, 2.4,  1, 320,
        "POCKET_SHALLOW", 10, 4],

    ["POC_24IN_21T",  90, 46, 21,  72, 1.5, 430, 3.2, 3.2,  7, 320,
        "POCKET_STANDARD", 16, 5],
